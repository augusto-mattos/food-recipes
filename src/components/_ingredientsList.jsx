...
function IngredientsList() {
  ...
  const handleGeneratePDF = () => {
    ...
    html2canvas(ingredientsList, {
      width: ingredientsList.offsetWidth,
      height: ingredientsList.offsetHeight,
    }).then((canvas) => {
  ...
  const handleGenerateShoppingList = () => {
    ...
    const shoppingListContent = shoppingListItems
      .map((item) => item.text)
      .join("\n");
  ...
  return (
    <>
      ...
      <div className="recipe-actions">
        <button
          className="ingrendients-list-btn"
